...
export const churches = pgTable("churches", {
  ...
  // shot at capturing the lead. The opener is always generated by the
  // AI model; if generation fails (timeout, error, throttle hit, or
  // monthly budget exhausted), outreach is skipped for that visitor.
